      ...
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 md:gap-16 text-left">
        ...
        <div className="space-y-4">
          ...
          <p className="flex items-start text-lg text-[#0B0B0B] space-x-3">
            ...
            <span>
              Mars Interiors, 24/7 Global Spaces, Peters Nine,<br />
              Near Josco Jewellers, Thodupuzha, Kerala<br />
              PinCode: 685584
            </span>
          </p>
        </div>
        ...
        <div className="space-y-4">
          ...
          <ul className="space-y-2 text-lg text-[#0B0B0B]">
            <li><a href="/" className="hover:text-[#17A396] transition-colors">Home</a></li>
            <li><a href="/aboutus" className="hover:text-[#17A396] transition-colors">About Us</a></li>
            <li><a href="/services" className="hover:text-[#17A396] transition-colors">Services</a></li>
            <li><a href="/contact" className="hover:text-[#17A396] transition-colors">Contact</a></li>
          </ul>
        </div>
        ...
        <div className="space-y-4">
          ...
          <ul className="space-y-3 text-lg text-[#0B0B0B]">
            <li className="flex items-center space-x-3">
              ...
              <a href="mailto:info@marsinterios.com" className="hover:underline">info@marsinterios.com</a>
            </li>
            <li className="flex items-center space-x-3">
              <FaWhatsapp className="w-6 h-6 text-[#17A396]" />
              <a href="https://wa.me/9567876460" className="hover:underline">+91 9567876460</a>
            </li>
            <li className="flex items-center space-x-3">
              <BiPhoneCall className="w-6 h-6 text-[#17A396]" />
              <a href="tel:+919562978418" className="hover:underline">+91 9562978418</a>
            </li>
          </ul>

          {/* Social Icons */}
          <div className="flex space-x-5 mt-4">
            <a href="https://www.instagram.com/mars_interiors_.co.in?igsh=MzRycTVjbndlNm90" target="_blank" className="text-2xl text-[#17A396] transition-colors">
              <FaInstagram className="w-8 h-8" />
            </a>
            <a href="https://wa.me/9567876460" target="_blank" className="text-2xl text-[#17A396]  transition-colors">
