          ...
          <div className="w-full md:w-1/2">
            ...
            <div className="space-y-4 text-left">
              <p className="text-[#0B0B0B] flex items-center justify-center md:justify-start">
                ...
                Mars Interiors, 24/7 Global Spaces, Peters Nine, Near Josco Jewellers, Thodupuzha, Kerala, PinCode: 685584
              </p>
              ...
              <p className="text-[#0B0B0B] flex items-center text-left md:justify-start">
                ...
                <a href="mailto:info@marsinteriors.com">info@marsinteriors.com</a>
              </p>
              <p className="text-[#0B0B0B] flex items-center text-left md:justify-start">
                <LuAlarmClock className="w-6 sm:w-8 h-6 sm:h-8 text-blue-500" />
                <span className="font-semibold ml-2">Working Hours:</span> Mon - Sat:- 10:00 AM - 7:00 PM
              </p>
              <h2 className="font-semibold text-lg sm:text-xl pt-6 flex items-center text-left md:justify-start">
                <MdManageAccounts className="w-6 sm:w-8 h-6 sm:h-8 mr-4 text-stone-700" /> Managing Directors
              </h2>
              <p className="text-[#0B0B0B] ml-8 md:ml-12 text-left">Marcel Mathew</p>
